...
- **Collisions (code-review, competitive-brief, review-contract):** confirmed DIFFERENT skills → **keep both, category-namespaced**, kept current by a deterministic scheduled updater (below).
