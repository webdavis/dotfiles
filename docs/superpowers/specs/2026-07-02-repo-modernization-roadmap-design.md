...
F-key smart-lights/openhue, terminal-notifier feedback; **R3 (2026-07-10): the F1 → OpenClaw
`127.0.0.1:18789` binding, the `openclaw` package, and the docs were removed by the Wave-3d cleanup PR,
operator owns the Todoist cleanup**); Karabiner
