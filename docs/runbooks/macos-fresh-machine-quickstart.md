...
1. **Retrieve the KeePassXC database** — from offline backup or iCloud Drive. Place at the path
...
- **Hot Corners / Mission Control assignments** — `defaults` keys vary by macOS major version; punt to
  v2.
