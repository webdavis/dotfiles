...
decision 3 required an honest look; this is it), and leave a one-paragraph pointer to this report so the
...
workflow. Nushell also ships a breaking release every 4 weeks with config-schema breaks every 2 to 5
...
| ---------------------------- | -------------------- | --------------------------------------------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **nushell**                  | 0.114.0 (2026-07-04) | pre-1.0; 4-wk cadence; config-schema breaks every 2 to 5 releases                                   | -                | [releases](https://github.com/nushell/nushell/releases), [road-to-1.0](https://www.nushell.sh/blog/2023-06-27-road-to-1_0.html), [#14102](https://github.com/nushell/nushell/discussions/14102) |
