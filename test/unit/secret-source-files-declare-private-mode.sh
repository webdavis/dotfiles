...
declare -A SECRET_SOURCE_TARGET_PINS=(
  ...
  ["private_dot_hermes/encrypted_private_config.yaml.age"]=".hermes/config.yaml.age"
  ["private_dot_hermes/private_dot_env.tmpl"]=".hermes/.env"
  ["private_dot_hermes/profiles/private_butters/encrypted_private_config.yaml.age"]=".hermes/profiles/butters/config.yaml.age"
  ["private_dot_hermes/profiles/private_concerned/encrypted_private_config.yaml.age"]=".hermes/profiles/concerned/config.yaml.age"
  ["private_dot_hermes/profiles/private_elaine/encrypted_private_config.yaml.age"]=".hermes/profiles/elaine/config.yaml.age"
  ["private_dot_hermes/profiles/private_nicodemus/encrypted_private_config.yaml.age"]=".hermes/profiles/nicodemus/config.yaml.age"
