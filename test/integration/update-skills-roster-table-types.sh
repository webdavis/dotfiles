...
# RESTORING an exempted skill's ~/.claude link (last30days). A deployed array or
# string must refuse the run, not sail past the gate into that fail-open.
reset_stamp
cat >"$LOCK" <<'EOF'
{
  "version": 2,
