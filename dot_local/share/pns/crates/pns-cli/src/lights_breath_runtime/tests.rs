mod tests {
    ...
    fn two_breathing_lamps_share_one_schedule_rather_than_running_back_to_back() {
        ...
        let quick = pns_domain::lamps::config::Breath {
            duration_ms: 2000,
            high: 100,
            low: 30,
        };
        let slow = pns_domain::lamps::config::Breath {
            duration_ms: 4000,
            high: 60,
            low: 10,
        };
        drive_breaths(
            ...
            &[
                Breathing {
                    ...
                    held: pns_domain::lights::held::Held::Blocked,
                    cycle: pns_domain::lights::breath::breath_cycle(&quick),
                    color: pns_domain::pulse::BLOCKED_COLOR,
                    resume: pns_domain::lights::breath::Resume::default(),
                },
                Breathing {
                    path: "light/b".to_string(),
                    held: pns_domain::lights::held::Held::Looping,
                    cycle: pns_domain::lights::breath::breath_cycle(&slow),
                    color: pns_domain::pulse::LOOP_COLOR,
                    resume: pns_domain::lights::breath::Resume::default(),
                },
            ],
            no_time_passes(),
    ...
    fn a_slow_write_stops_the_schedule_at_the_budget_and_lands_where_it_really_did() {
        ...
        let landings = drive_breaths(
            ...
            &[Breathing {
                path: "light/a".to_string(),
                held: pns_domain::lights::held::Held::Blocked,
                cycle: pns_domain::lights::breath::breath_cycle(
                    &pns_domain::lamps::config::Breath {
                        duration_ms: 2_000,
                        high: 100,
                        low: 30,
                    },
    ...
    fn a_landing_is_timed_by_the_fade_that_ran_and_not_by_the_cycles_first_leg() {
        ...
        let landings = drive_breaths(
            ...
            &[Breathing {
                path: "light/a".to_string(),
                held: pns_domain::lights::held::Held::Looping,
                cycle: pns_domain::lights::breath::breathe_then_flare_cycle(
