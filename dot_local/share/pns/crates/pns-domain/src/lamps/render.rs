...
pub fn held_render(
    held: crate::lights::held::Held,
    lights: &crate::lamps::config::Lights,
    showing: Showing,
) -> (crate::pulse::PulseColor, Vec<crate::lights::breath::Leg>) {
    let (color, cycle) = match held {
        crate::lights::held::Held::Blocked => (
            crate::pulse::BLOCKED_COLOR,
            crate::lights::breath::breath_cycle(&lights.blocked.breath),
        ),
        crate::lights::held::Held::Looping => (
            crate::pulse::LOOP_COLOR,
            crate::lights::breath::breathe_then_flare_cycle(&lights.looping.breathe_then_flare),
        ),
    ...
    // house is asleep.
    match showing {
        Showing::Dimmed => (color, crate::lights::breath::breath_cycle(&lights.dim)),
