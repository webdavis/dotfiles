...
alias ebf='nvim ~/.dotfiles-webdavis.git/bash_functions'
alias ebk='nvim ~/.dotfiles-webdavis.git/bash_bindings'
alias ebd='nvim ~/.dotfiles-webdavis.git/docker_functions'
alias ebz='nvim ~/.dotfiles-webdavis.git/fzf_bindings'
alias ei='nvim ~/.dotfiles-webdavis.git/config/i3/config'
alias eib='nvim ~/.dotfiles-webdavis.git/config/i3blocks/config'
alias evrc='nvim ~/.dotfiles-webdavis.git/vimrc'
alias en='nvim ~/.dotfiles-webdavis.git/config/nvim/init.vim'
alias et='nvim ~/.dotfiles-webdavis.git/tmux.conf'
alias eg='nvim ~/.dotfiles-webdavis.git/gitconfig'
alias o='xdg-open'
alias p='python'
alias g='git'
