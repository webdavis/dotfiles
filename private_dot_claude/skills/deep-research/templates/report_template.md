...
[Follow same detailed structure as Finding 1] [Minimum 300 words per finding] \[Include multiple
...
**Insight 1: [Name]** [What you discovered by connecting information across sources] \[Why this matters
even though no single source said it explicitly\]
...
1. **[Continue with similar detail...]**
...
[1] Author Name or Organization ([YEAR]). "Full Title of Article or Paper". Publication Name or Website.
https://full-url.com (Retrieved: [CURRENT_DATE])

[2] Second Author ([YEAR]). "Second Article Title". Journal Name, Volume(Issue), pages.
https://doi-or-url.com (Retrieved: [CURRENT_DATE])
...
**Research Mode:** [Quick/Standard/Deep/UltraDeep] **Total Sources:** [Number] **Word Count:**
[Approximate count] **Research Duration:** [Time taken] **Generated:** [Date and time] **Validation
Status:** [Passed with X warnings / Passed without warnings]
