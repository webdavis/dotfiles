...
1. Citations formatted [1], [2], [3]
1. Bibliography matches citations
1. No placeholder text (TBD, TODO)
1. Word count reasonable (500-10000)
1. Minimum 10 sources
...
1. Run `python scripts/verify_citations.py --report [path]`
1. If EITHER fails:
   - Read error output carefully
   - Fix the specific issues identified
   - Re-run BOTH validators
1. Maximum 3 retry cycles. If still failing after 3 cycles: STOP and report issues to user.
...
- Convert: "\* Market size: $2.4B" -> "The global market reached $2.4 billion in 2023, driven by
  increasing consumer demand [1]."
