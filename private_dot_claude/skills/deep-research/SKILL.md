...
**Default assumptions:** Technical query = technical audience. Comparison = balanced perspective. Trend =
recent 1-2 years.
...
1. **Phase 8 (Report):** Load [report-assembly.md](./reference/report-assembly.md) for progressive
   generation
1. **HTML/PDF output:** Load [html-generation.md](./reference/html-generation.md)
1. **Quality checks:** Load [quality-gates.md](./reference/quality-gates.md)
1. **Long reports (>18K words):** Load [continuation.md](./reference/continuation.md)
...
**Use:** Comprehensive analysis, technology comparisons, state-of-the-art reviews, multi-perspective
