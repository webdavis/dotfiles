...
Watch, and the answer round-trips back to the agent without leaving the terminal. It also covers Claude
...
`moshi-hook install` is non-destructive — it writes Moshi entries into `~/.claude/settings.json`,
