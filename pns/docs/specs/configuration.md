...
| `lights.unseen.after_secs`          | integer         | `300` (`DEFAULT_UNSEEN_AFTER_SECS`)                      | 0 to 86400 (`MAX_THRESHOLD_SECS`); zero means "at once"                                                                         | no     | `bounded` refusal naming `lights.unseen`                                                                                                         | `src/config.rs:parse_unseen`                                                  | `every_lights_number_is_bounded_on_both_sides_and_refused_by_name_outside_them`                                                                                       |
