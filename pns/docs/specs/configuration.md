...
| `recap.minimum_away`        | duration string   | `"20m"` (`DEFAULT_MINIMUM_AWAY`)                | "0s" to "24h" inclusive; "0s" leaves the event count as the only bar                             | no     | not a duration: `` `recap` key `minimum_away` has type `{type}`, not a duration like "5m" ``; over: `` `recap` key `minimum_away` "25h" is outside 0s to 24h ``                                                                                                                                                                                                                       | `config/recap.rs:parse_recap`                     | `the_minimum_time_away_is_a_duration_the_operator_can_state`, `a_minimum_time_away_that_is_not_a_duration_up_to_a_day_is_refused_naming_the_key` |
...
| `minimum_away` not a duration                                         | `` `recap` key `minimum_away` has type `{type}`, not a duration like "5m" ``                                                                                                                                                                                        | `Invalid`                                                  | same                                                                                   |
| `minimum_away` over the ceiling                                       | `` `recap` key `minimum_away` "25h" is outside 0s to 24h ``                                                                                                                                                                                                         | `Invalid`                                                  | same                                                                                   |
