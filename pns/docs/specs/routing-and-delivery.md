...
- **Idempotency and duplicates:** A recap posts to `pns-recap` first and, if that is refused, ONCE more
  ...
  asserts exactly two POSTs, to `/webhooks/pns-recap` then `/webhooks/pns-events`, and that the second body
