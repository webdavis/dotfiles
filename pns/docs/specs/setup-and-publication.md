...
| 15  | `Card you a second time about an approval left unanswered? [y/N]: `                                 | Whether to arm the second card about an unanswered approval (`Answers::remind`)                     | No                                                  | No; `[remind]` is composed commented out                                                                                                                                                                                                                                                                                                                                                      | Not a yes is a no                                                                                                                                                                                                                                                                                                            | `src/main.rs:the_only_answer_that_arms_a_feature_is_a_yes_somebody_typed`; `src/setup.rs:every_armed_feature_reaches_the_parsed_config_carrying_its_own_answers`              |
...
- Forbidden side effects: a declined table must be COMMENTED OUT, never written with empty values:
  `modes = []` and `rooms = []` load to the same nothing an absent table does and READ as a feature set
