...
| P6  | `codex exec --ephemeral --skip-git-repo-check -C <home> -s read-only -` with the prompt on stdin (`src/main.rs:condense`)         | the `stop` hook                                         | `PNS_CONDENSER_DEADLINE`, else `CONDENSER_DEADLINE` = 30s; read cap `PROBE_READ_MAX` = 1 MiB                                                                                                            | as P5                                                                                                         | yes, as P3                                                                                                         | `None` falls back to trimming the reply (`src/main.rs:condense`)                                                               | as P5                                                                                                |
