...
| P6  | `codex exec --skip-git-repo-check --ephemeral -s read-only -C <home> -` with the prompt on stdin (`src/main.rs:summarize`)         | the `stop` hook                                         | `PNS_SUMMARIZER_DEADLINE`, else `SUMMARIZER_DEADLINE` = 30s; read cap `PROBE_READ_MAX` = 1 MiB                                                                                                            | as P5                                                                                                         | yes, as P3                                                                                                         | `None` falls back to trimming the reply (`src/main.rs:summarize`)                                                               | as P5                                                                                                |
