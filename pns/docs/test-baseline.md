...
| `a_record_missing_a_key_degrades_to_a_thinner_one_and_a_line_that_is_not_json_is_refused` | `src/nag/tests.rs`                           | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `a_record_with_every_field_set_round_trips_through_its_on_disk_form`                      | `src/nag/tests.rs`                           | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `a_session_id_that_cannot_be_a_filename_names_nothing_at_all`                             | `src/nag/tests.rs`                           | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `an_ordinary_session_id_names_a_record_a_marker_a_job_and_a_claim`                        | `src/nag/tests.rs`                           | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `two_ids_that_differ_only_after_a_dot_claim_two_different_names`                          | `src/nag/tests.rs`                           | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |

The following named tests add coverage at owned file-protocol boundaries. The journal and remind ownership
...
| `a_record_claim_never_overwrites_a_batch_that_owner_already_holds`          | `crates/pns-adapters/src/protocols/remind/claims/tests.rs`                 | Adapter or use-case behavior contract |
...
| `two_record_claimers_have_one_owner_even_without_the_fire_lock`             | `crates/pns-adapters/src/protocols/remind/claims/tests.rs`                 | Adapter or use-case behavior contract |
...
| `config::tests::delivery::a_class_table_names_its_route_and_whether_it_passes_the_mute`                               | quiet-behavior 7: the class table's two keys, their defaults and the mute exception                                         |
...
| `delivery_class::a_class_no_table_defines_is_refused_and_named_on_both_paths`                                        | quiet-behavior 7: a class no `[delivery_class.<name>]` defines is refused with exit 2 and named                           |
