...
| `a_record_missing_a_key_degrades_to_a_thinner_one_and_a_line_that_is_not_json_is_refused` | `src/remind/tests.rs`                        | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `a_record_with_every_field_set_round_trips_through_its_on_disk_form`                      | `src/remind/tests.rs`                        | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `a_session_id_that_cannot_be_a_filename_names_nothing_at_all`                             | `src/remind/tests.rs`                        | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `an_ordinary_session_id_names_a_record_a_marker_a_job_and_a_claim`                        | `src/remind/tests.rs`                        | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
...
| `two_ids_that_differ_only_after_a_dot_claim_two_different_names`                          | `src/remind/tests.rs`                        | `crates/pns-adapters/src/protocols/remind/tests.rs`                        | Adapter contract, moved with its behavior |
