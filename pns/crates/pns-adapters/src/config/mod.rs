...
mod profiles;
use profiles::{DEFAULT_LOCATION_POLL_SECS, parse_profiles};
mod values;
...
use schema::{
    PRODUCER_KEYS, PROFILE_KEYS, PROFILES, TARGET_KEYS, admits, admits_flat, duration_key,
    duration_value, keys_of, nonzero_duration_key, unknown_key,
};
