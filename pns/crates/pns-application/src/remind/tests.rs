use super::{Outcome, RunRemind};
use crate::{Claimed, RaiseNotification, RemindRecords};
use pns_domain::EventArgs;
use pns_domain::remind::Record;
...
impl RemindRecords for Recorder {
    ...
    fn drop_claim(&self, session_id: &str, _reason: Option<pns_domain::remind::Dropped>) {
