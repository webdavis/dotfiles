mod fixtures {
    ...
    impl pns_adapters::Bridge for PollBridge {
    ...
    pub(crate) fn poll_published<B: pns_adapters::Bridge>(
        bridge: &B,
        state: &std::path::Path,
    ...
    pub(crate) fn at_the_desk(status: pns_domain::PresenceStatus) -> pns_domain::Snapshot {
        pns_domain::Snapshot {
            status,
            desk_idle_secs: Some(0),
            screen_locked: Some(false),
            home: pns_domain::home::HomePresence::Unknown,
    ...
    pub(crate) fn in_the_kitchen() -> pns_domain::Snapshot {
        pns_domain::Snapshot {
            desk_idle_secs: None,
            ..at_the_desk(pns_domain::PresenceStatus::Room {
